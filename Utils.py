...
def build_paths(print_paths=True):
    ...
    pretrained_model_path = '/groups/course.crcvreu/Data/Pretrained/c3d-pretrained.pth'

    class_idxs = '/datasets/UCF-101/ActionRecognitionSplits/classInd.txt'
    train_split = '/datasets/UCF-101/ActionRecognitionSplits/trainlist01.txt'
    test_split = '/datasets/UCF-101/ActionRecognitionSplits/testlist01.txt'
    frames_root = '/datasets/UCF-101/Frames/frames-128x128/'
